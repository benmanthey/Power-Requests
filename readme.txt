...
Requirements:
LabVIEW 2024, Basic Edition. No additional files needed.
Windows 7 and above only
The first version of LabVIEW to support Win 7 is 2009 SP1
...
Version:
2.0.0.0 -- Updated to LabVIEW 2024, no other changes
...
1.2.1.0 -- January 26, 2017 -- Modified Close Handle and Power Clear Request vis so an error in does not prevent the dll call from working.
